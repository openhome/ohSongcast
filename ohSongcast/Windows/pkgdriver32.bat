...
Signtool sign /v /a /ac Driver\gsrootr1.crt /t http://timestamp.verisign.com/scripts/timestamp.dll Build\Driver32\ohSongcast.sys >nul
inf2cat.exe /driver:Build\Driver32 /os:Vista_X86,7_X86 /v >nul
Signtool sign /v /a /ac Driver\gsrootr1.crt /t http://timestamp.verisign.com/scripts/timestamp.dll Build\Driver32\ohSongcast.cat >nul
