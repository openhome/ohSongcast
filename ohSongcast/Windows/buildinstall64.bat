...
link /SUBSYSTEM:windows /ENTRY:mainCRTStartup /nologo /map Iphlpapi.lib /incremental:no /out:Build\Obj\Install64.exe Build\Obj\Install64.obj setupapi.lib
copy Build\Obj\Install64.exe Build\Driver64\Install64.exe
signtool sign /v /a /sm /t http://timestamp.verisign.com/scripts/timestamp.dll Build\Driver64\Install64.exe
