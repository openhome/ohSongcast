...
link /SUBSYSTEM:windows /ENTRY:mainCRTStartup /nologo /map Iphlpapi.lib /incremental:no /out:Build\Obj\Install32.exe Build\Obj\Install32.obj setupapi.lib
copy Build\Obj\Install32.exe Build\Driver32\Install32.exe
signtool sign /v /a /sm /t http://timestamp.verisign.com/scripts/timestamp.dll Build\Driver32\Install32.exe
