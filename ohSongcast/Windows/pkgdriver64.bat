...
Signtool sign /v /a /sm /ac Driver\gsrootr1.crt /t http://timestamp.verisign.com/scripts/timestamp.dll Build\Driver64\ohSongcast.sys >nul
inf2cat.exe /driver:Build\Driver64 /os:Vista_X64,7_X64 /v >nul
Signtool sign /v /a /sm /ac Driver\gsrootr1.crt /t http://timestamp.verisign.com/scripts/timestamp.dll Build\Driver64\ohSongcast.cat >nul
